...
def get_layout(boundary: np.array, title: Optional[str] = None, extra_str: Optional[str] = None) -> go.Layout:
    """
    ...
    if extra_str is not None:
        return go.Layout(
            yaxis=dict(range=boundary[1::2], scaleanchor="x", scaleratio=1),
