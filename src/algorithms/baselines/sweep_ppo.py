...
from src.algorithms.baselines.architectures.sweep.sweep_ppo_actor_critic import (
    SweepPPOActorCritic,
)
from src.algorithms.baselines.buffers.single_agent_on_policy_buffer import (
    SingleAgentOnPolicyBuffer,
)
...
class SweepPPO(SwarmPPO):
    ...
    def __init__(self, config: ConfigDict, seed: Optional[int] = None) -> None:
        ...
        self._value_function_aggr = "agent"
    ...
    def _build_normalizer(self, ppo_config: ConfigDict) -> AbstractEnvironmentNormalizer:
        ...
        if normalize_observations:
            from src.algorithms.baselines.normalizers.sweep_environment_normalizer import (
                SweepEnvironmentNormalizer,
            )

            environment_normalizer = SweepEnvironmentNormalizer(
    ...
    def _build_buffer(self, ppo_config):
        ...
        rollout_buffer = SingleAgentOnPolicyBuffer(
