...
from src.algorithms.baselines.architectures.sweep_dqn_architectures import (
    SweepDQNPolicy,
)
...
class SweepDQN(SwarmDQN):
    ...
    def _get_random_actions(self):
        ...
        """
        action = torch.randint(low=0, high=self._environment.action_dimension, size=(1,)).to(self.device)
        return action
