...
class AbstractMultiAgentOnPolicyBuffer(abc.ABC):
    ...
    def _get_values_advantages_returns(
        ...
        """
        raise NotImplementedError(
            "Abstract MultiAgentOnPolicyBuffer does not " "implement '_get_values_advantages_returns()'"
        )

    def compute_returns_and_advantage(self, last_value: torch.Tensor) -> None:
        raise NotImplementedError(
            "Abstract MultiAgentOnPolicyBuffer does not " "implement 'compute_returns_and_advantage()'"
        )
