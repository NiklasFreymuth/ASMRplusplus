...
def get_swarm_base(
    graph_env: AbstractSwarmEnvironment, network_config: ConfigDict, device
) -> AbstractMessagePassingBase:
    """
    ...
    params = dict(
        in_node_features=graph_env.num_node_features,
    ...
    else:  # get a full message passing network for, e.g., "hmpn" as input
