...
from src.algorithms.rl.off_policy.buffers.swarm_dqn_buffer import (
    DQNBufferSamples,
    DQNTransition,
    SwarmDQNBuffer,
)
from src.algorithms.rl.off_policy.util.segment_tree import (
    MinSegmentTree,
    SumSegmentTree,
)
...
class SwarmDQNPrioritizedBuffer(SwarmDQNBuffer):
    ...
    def _sample_transitions_and_indices(
        self, num_samples: int, beta: float
    ) -> Tuple[Sequence[DQNTransition], List[int]]:
    ...
    def _create_prioritized_buffer_samples(
        self, mini_batch: Sequence[DQNTransition], indices: List[int], beta: float
        ...
        return DQNPrioritizedBufferSamples(
            dqn_buffer_sample.observations,
            dqn_buffer_sample.actions,
            dqn_buffer_sample.rewards,
            dqn_buffer_sample.next_observations,
            dqn_buffer_sample.dones,
            weights,
            indices,
        )
