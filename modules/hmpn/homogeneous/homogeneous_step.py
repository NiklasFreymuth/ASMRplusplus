...
class HomogeneousStep(AbstractStep):
    ...
    def __init__(self,
        ...
        if node_update_type == "message_passing":
            from modules.hmpn.homogeneous.homogeneous_modules import HomogeneousMessagePassingNodeModule
            ...
            from modules.hmpn.homogeneous.homogeneous_modules import HomogeneousGatNodeModule
