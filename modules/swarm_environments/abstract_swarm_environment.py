...
class AbstractSwarmEnvironment(gym.Env, ABC):
    ...
    def num_agents(self) -> int:
        ...
        Returns: The number of agents currently in the environment.
            This will usually coincide with the number of nodes.
        """
        raise NotImplementedError("AbstractSwarmEnvironment does not implement num_agents")
    ...
    def agent_node_type(self) -> str:
        """
        Returns: The name of the node type that acts as an agent. For homogeneous graphs, this choice does not make
            a difference.
        """
        return AGENT
