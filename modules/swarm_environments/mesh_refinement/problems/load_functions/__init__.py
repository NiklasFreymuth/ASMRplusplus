...
def create_load_function(
    *,
    ...
    if target_function_name == "gmm":
        from modules.swarm_environments.mesh_refinement.problems.load_functions.gmm_density import (
            GMMDensity,
        )
    ...
    target_function_instance = target_function(
